...
<stripes:layout-component name="titre">Interface Admin du groupe</stripes:layout-component>
...
<stripes:layout-component name="contenu">
  ...
  <p>Actions possibles pour le groupe :</p>
  <div class="actions"><span class="barre"></span>
                       ${actionBean.vueActions}
                       <span class="barre"></span>
  </div><div class="finActions"></div>
