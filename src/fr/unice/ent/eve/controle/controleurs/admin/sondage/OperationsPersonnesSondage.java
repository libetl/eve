...
public class OperationsPersonnesSondage extends ActionBeanTraitant {
  ...
  public OperationsPersonnesSondage () {
    super ();
  }
  ...
  public Resolution formulaire () {
    ...
    this.formPermissions = (String) ((Object[]) this.getContext ()
        .getRequest ().getSession ().getAttribute ("resultatDerniereCommande"))[3]; //$NON-NLS-1$

    this.getContext ().getRequest ().getSession ()
        .removeAttribute ("resultatDerniereCommande"); //$NON-NLS-1$

    return new ForwardResolution (
        "/vue/jsp/admin/sondage/operationspersonnes.jsp"); //$NON-NLS-1$
  }
