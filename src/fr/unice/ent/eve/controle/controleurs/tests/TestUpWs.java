...
public class TestUpWs implements ActionBean {
  ...
  public Resolution testAppel () {
    try {
      final String result = ConsommateurWS
          .listeMapsVersString (AppelWS.appel (
              this.context.getLocale (),
              new ServiceAuth (
                  "http://127.0.0.1/uPortal/services/UportalService", //$NON-NLS-1$
                  "fr.unice.ent.eve.controle.ws.client.uportalservice.UportalService"), //$NON-NLS-1$
              this.requete));
