...
public class UportalServiceUserNotFoundException extends
  ...
  public UportalServiceUserNotFoundException (final java.lang.Exception target) {
    super (target);
    this.fault = new Object ();
  }

  public UportalServiceUserNotFoundException (final java.lang.Object f) {
    this.fault = f;
  }

  public UportalServiceUserNotFoundException (final java.lang.String message,
