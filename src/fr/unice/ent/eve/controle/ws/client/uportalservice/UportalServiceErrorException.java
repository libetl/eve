...
public class UportalServiceErrorException extends org.apache.axis.AxisFault {
  ...
  public UportalServiceErrorException (final java.lang.Exception target) {
    super (target);
    this.fault = new Object ();
  }

  public UportalServiceErrorException (final java.lang.Object f) {
    this.fault = f;
  }

  public UportalServiceErrorException (final java.lang.String message,
